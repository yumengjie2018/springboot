...
public class GpsCoordinateUtils {
         ...
         * @return [纬度, 经度]
         */
        public static HashMap<String, Object> calWGS84toBD09(double latitude, double longitude) {
            Point dev = calDev(latitude, longitude);
            double retLat = latitude + dev.getLatitude();
            double retLon = longitude + dev.getLongitude();
         ...
         * @return [纬度, 经度]
         */
        public static HashMap<String,Object> calGCJ02toBD09(double latitude, double longitude) {
            ...
            latLon.put("retLat",retLat);
            latLon.put("retLon",retLon);
            return latLon;
        }
